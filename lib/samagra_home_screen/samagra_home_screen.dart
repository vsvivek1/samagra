...
class SamagraHomeScreen extends StatefulWidget {
  @override
  _SamagraHomeScreenState createState() => _SamagraHomeScreenState();
}

class _SamagraHomeScreenState extends State<SamagraHomeScreen> {
