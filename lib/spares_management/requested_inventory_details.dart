...
class _RequestedInventoryDetailsPageState
  ...
  Future<void> fetchInterestedPeople() async {
    try {
      String apiUrl =
          'http://192.168.29.92:8000/api/requested_inventories/${widget.inventory['id']}/interested';
  ...
  Future<void> fetchComments() async {
    try {
      String commentsUrl =
          'http://192.168.29.92:8000/api/requested_inventories/${widget.inventory['id']}/comments';
  ...
  Future<void> expressInterest() async {
    try {
      String interestUrl =
          'http://192.168.29.92:8000/api/requested_inventories/${widget.inventory['id']}/express-interest';
