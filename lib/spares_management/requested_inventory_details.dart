...
class _RequestedInventoryDetailsPageState
  ...
  Future<void> fetchInterestedPeople() async {
    try {
      String apiUrl =
          'localUrl/api/requested_inventories/${widget.inventory['id']}/interested';
  ...
  Future<void> fetchComments() async {
    try {
      String commentsUrl =
          'localUrl/api/requested_inventories/${widget.inventory['id']}/comments';
  ...
  Future<void> expressInterest() async {
    try {
      String interestUrl =
          'localUrl/api/requested_inventories/${widget.inventory['id']}/express-interest';
