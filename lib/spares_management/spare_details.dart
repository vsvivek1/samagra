...
class _SpareDetailsPageState extends State<SpareDetailsPage> {
  ...
  Future<void> fetchInterestedPeople() async {
    try {
      String apiUrl =
          'http://192.168.100.104:8000/api/spares/${widget.spare['id']}/interested';
  ...
  Future<void> fetchComments() async {
    try {
      String commentsUrl =
          'http://192.168.100.104:8000/api/spares/${widget.spare['id']}/comments';
  ...
  Future<void> expressInterest() async {
    try {
      String interestUrl =
          'http://192.168.100.104:8000/api/spares/${widget.spare['id']}/express-interest';
