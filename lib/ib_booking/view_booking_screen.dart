...
class ViewBookingsScreen extends StatefulWidget {
  ...
  const ViewBookingsScreen({Key? key, this.caretakerIbIds = const []})
      : super(key: key);
                          ...
                          return Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(headerDate,
                                    style: const TextStyle(
                                        fontWeight: FontWeight.bold)),
                              ),
                              ...entry.value.map((b) {
                                final from =
                                    _fmt.format(DateTime.parse(b['from_date']));
                                final to =
                                    _fmt.format(DateTime.parse(b['to_date']));
                                return ListTile(
                                  title: Text(b['employee_name']??"KSEB EMPLOYEE" as String),
                                  subtitle: Text(
                                    'Room ${b['ib_room_id']}\n'
                                    'From $from to $to\n'
